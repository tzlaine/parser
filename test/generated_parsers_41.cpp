...
TEST(parser, generated_41_000)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> -int_ >> eps >> eps);
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_002)
{
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_003)
{
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_004)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_005)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_41_006)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_007)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_008)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_009)
{
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
...
TEST(parser, generated_41_010)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_011)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_012)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_013)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
...
TEST(parser, generated_41_014)
{
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_41_015)
{
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<int>>>>));
...
TEST(parser, generated_41_016)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (*char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
...
TEST(parser, generated_41_017)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<char>>, tuple<std::vector<char>, optional<int>>>>>));
...
TEST(parser, generated_41_018)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_019)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (-int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_41_020)
{
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_41_021)
{
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_022)
{
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_023)
{
    ...
    {
        constexpr auto parser = (*char_ >> eps >> *char_ >> eps) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(eps >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_024)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_025)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_026)
{
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(-int_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_027)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (eps >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_41_028)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_41_029)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(eps >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_030)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<std::vector<optional<int>>>>>>));
...
TEST(parser, generated_41_031)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_032)
{
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_033)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_41_034)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (eps >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_035)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(-int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_036)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_037)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_038)
{
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_41_039)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (eps >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<optional<int>>, std::vector<char>>>>>>));
...
TEST(parser, generated_41_040)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_41_041)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (-int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_41_042)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(-int_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_41_043)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_41_044)
{
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(-int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_41_045)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_41_046)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_41_047)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_41_048)
{
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> *char_ >> eps) | (*char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
...
TEST(parser, generated_41_049)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> *char_ >> eps) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
