...
TEST(parser, generated_27_000)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> eps >> -int_);
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_001)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_002)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_003)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_004)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_005)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_006)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_27_007)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_27_008)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<int>>>>));
...
TEST(parser, generated_27_009)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, std::vector<char>>>>));
...
TEST(parser, generated_27_010)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_011)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_012)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_013)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_014)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_015)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_27_016)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_017)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_27_018)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_27_019)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_27_020)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_27_021)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_022)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, optional<int>>>>));
...
TEST(parser, generated_27_023)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_27_024)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_27_026)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_27_027)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_028)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_27_029)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_27_030)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, tuple<std::vector<optional<int>>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_27_031)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> *char_ >> -int_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_032)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> *char_ >> -int_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_27_036)
{
    ...
    {
        constexpr auto parser = (eps >> -int_ >> eps) | -(*char_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (eps >> -int_ >> eps) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_27_037)
{
    ...
    {
        constexpr auto parser = (eps >> -int_ >> eps) | (*char_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_27_038)
{
    ...
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | (*char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_27_040)
{
    ...
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | (*char_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_27_045)
{
    ...
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | (*char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_27_046)
{
    ...
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
