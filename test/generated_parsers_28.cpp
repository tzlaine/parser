...
TEST(parser, generated_28_011)
{
    ...
    {
        constexpr auto parser = (eps >> -int_ >> eps) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_28_014)
{
    {
        constexpr auto parser = (eps >> -int_ >> eps) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_28_016)
{
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<int>>>));
...
TEST(parser, generated_28_022)
{
    {
        constexpr auto parser = -(eps >> -int_ >> eps) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_28_030)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_28_040)
{
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_28_046)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_) | -(-int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<int>>>>));
