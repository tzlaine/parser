...
TEST(parser, generated_87_000)
{
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (*char_ >> *char_ >> -int_ >> -int_);
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(*char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_001)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_002)
{
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_003)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_004)
{
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_005)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_006)
{
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | -(-int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (*char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_87_007)
{
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (*char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<optional<int>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_008)
{
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<optional<int>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (-int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_009)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_010)
{
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | -(-int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_011)
{
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_87_012)
{
    {
        constexpr auto parser = -(-int_ >> eps >> eps >> -int_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> eps >> eps >> -int_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<optional<int>>>>));
...
TEST(parser, generated_87_013)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(eps >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_014)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_015)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_016)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_017)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_018)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_020)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_021)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_022)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_023)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_024)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_87_025)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_026)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_027)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_028)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
...
TEST(parser, generated_87_029)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<optional<int>>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_87_030)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_87_031)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (-int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_87_032)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
...
TEST(parser, generated_87_033)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
...
TEST(parser, generated_87_034)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_035)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_87_036)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_037)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_87_038)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_039)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_87_040)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (-int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_87_041)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_87_042)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_87_043)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_87_044)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_87_045)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_87_046)
{
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<int>>>>));
...
TEST(parser, generated_87_047)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
...
TEST(parser, generated_87_048)
{
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_87_049)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>>>, optional<std::vector<optional<int>>>>>>));
