...
namespace boost { namespace yaml { namespace parser {
    ...
    struct block_styles_t
    {
        ...
        qi::rule<iterator_t, void(int, chomping_t, std::string &)>
            chomped_empty;
        ...
        qi::rule<iterator_t, std::string(int), qi::locals<int, chomping_t>>
            literal;

        qi::rule<iterator_t, std::string(int), qi::locals<std::string>>
            literal_text;
        qi::rule<iterator_t, std::string(int)> literal_next;
        qi::rule<iterator_t, std::string(int, chomping_t)>
        ...
        qi::rule<
            iterator_t,
            ast::value_t(int n, context_t),
            qi::locals<int, eoi_state_t>>
            block_indented;
        qi::rule<iterator_t, ast::seq_t(int n)> compact_sequence;

        qi::rule<iterator_t, ast::map_t(int), qi::locals<int, iterator_range_t>>
            block_mapping;
        ...
        qi::rule<iterator_t, ast::value_t(int), qi::locals<eoi_state_t>>
