...
#ifndef BOOST_PARSER_DETAIL_TEXT_SUBRANGE_HPP
#define BOOST_PARSER_DETAIL_TEXT_SUBRANGE_HPP
...
namespace std::ranges {
    ...
    inline constexpr bool enable_borrowed_range<boost::parser::detail::text::subrange<I, S>> =
        true;
}
