...
void compile_or_seq_attribute()
{
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> *char_);
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> eps >> *char_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> eps >> eps >> *char_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> eps >> eps >> *char_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(eps >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(eps >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(eps >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>, optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<optional<int>>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (-int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (-int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, tuple<std::vector<char>, optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<int>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<optional<int>>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<std::vector<optional<int>>, std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> -int_ >> *char_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(first, last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> -int_ >> *char_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
    }
    {
    ...
    {
        constexpr auto parser = (*char_) | (eps >> eps);
        using attr_t = decltype(parse(first, last, parser));
