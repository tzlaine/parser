...
TEST(parser, generated_047_010)
{
    ...
    }
    {
        ...
        EXPECT_FALSE(fail_attr);
        {
            tuple<std::vector<char>, optional<variant<std::vector<char>, optional<int>>>, std::vector<int>> attr;
            auto const copy = attr;
            EXPECT_FALSE(parse(first, last, fail_parser, attr));
            EXPECT_EQ(attr, copy);
        }
...
TEST(parser, generated_047_012)
{
    ...
    }
    {
        ...
        EXPECT_FALSE(fail_attr);
        {
            tuple<std::vector<char>, optional<variant<optional<int>, std::vector<char>>>, std::vector<int>> attr;
            auto const copy = attr;
            EXPECT_FALSE(parse(first, last, fail_parser, attr));
            EXPECT_EQ(attr, copy);
        }
