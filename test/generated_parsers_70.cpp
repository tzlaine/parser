...
TEST(parser, generated_70_003)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_70_006)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> *char_) | -(eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<std::vector<optional<int>>>>>>));
...
TEST(parser, generated_70_010)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_70_012)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | -(eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
...
TEST(parser, generated_70_013)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> *char_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_70_016)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_70_017)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_70_018)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
...
TEST(parser, generated_70_027)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | -(eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_70_028)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<char>>>>));
...
TEST(parser, generated_70_030)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_70_032)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> *char_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, optional<int>>>>));
...
TEST(parser, generated_70_033)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
...
TEST(parser, generated_70_034)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_70_037)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> *char_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>, std::vector<char>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_70_038)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> *char_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_70_042)
{
    ...
    {
        constexpr auto parser = -(-int_ >> -int_ >> eps) | -(eps >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_70_045)
{
    ...
    {
        constexpr auto parser = (-int_ >> -int_ >> eps) | (-int_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (-int_ >> -int_ >> eps) | -(-int_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_70_046)
{
    {
        constexpr auto parser = -(-int_ >> -int_ >> eps) | (eps >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (-int_ >> -int_ >> eps) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_70_048)
{
    {
        constexpr auto parser = (-int_ >> -int_ >> eps) | -(eps >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
