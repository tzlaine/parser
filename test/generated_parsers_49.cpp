...
TEST(parser, generated_49_000)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> *char_ >> eps);
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_001)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_002)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_003)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_004)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_006)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_007)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_008)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> *char_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_009)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_49_010)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_011)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> *char_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_49_012)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> *char_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, std::vector<optional<int>>>>>));
