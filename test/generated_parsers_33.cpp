...
TEST(parser, generated_33_000)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (*char_ >> eps >> *char_ >> -int_);
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_001)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_002)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_003)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_004)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_005)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_006)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, tuple<optional<int>, std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_007)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_008)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_33_009)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(eps >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (-int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_010)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(eps >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (*char_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_33_011)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_012)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (*char_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, std::vector<char>>>>));
...
TEST(parser, generated_33_013)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(eps >> eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<char>>>>));
...
TEST(parser, generated_33_014)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_33_015)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_33_016)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_017)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_33_018)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_019)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (-int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_33_020)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<char>>>>));
...
TEST(parser, generated_33_021)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_33_022)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<tuple<std::vector<char>, optional<int>>>>>));
...
TEST(parser, generated_33_023)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_33_024)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_025)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<int>>>>));
...
TEST(parser, generated_33_026)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_33_027)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_33_028)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_33_029)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_33_030)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_33_031)
{
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<std::vector<optional<int>>>>>>));
...
TEST(parser, generated_33_032)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | -(-int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, optional<int>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, tuple<std::vector<optional<int>>, std::vector<char>>>>>));
...
TEST(parser, generated_33_033)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps >> -int_) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_034)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps >> -int_) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | -(eps >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_035)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(*char_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_036)
{
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | (*char_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (-int_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_037)
{
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | -(-int_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (-int_ >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_33_038)
{
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | (eps >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(*char_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_33_039)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_040)
{
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (*char_ >> eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(eps >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_041)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (eps >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_33_042)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (*char_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_043)
{
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | (*char_ >> eps >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_044)
{
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (-int_ >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | -(-int_ >> eps >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (eps >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<std::vector<char>>>));
...
TEST(parser, generated_33_045)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | (eps >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<std::vector<char>>, tuple<std::vector<char>, optional<int>>>>>));
...
TEST(parser, generated_33_046)
{
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (eps >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | -(-int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_047)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (-int_ >> *char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_048)
{
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | -(-int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (-int_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_33_049)
{
    ...
    {
        constexpr auto parser = -(eps >> *char_ >> eps >> eps) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> *char_ >> eps >> eps) | (eps >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, tuple<optional<int>, std::vector<char>, optional<int>>>>>));
