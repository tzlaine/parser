...
void compile_seq_attribute()
{
    ...
    }
    {
        ...
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, std::optional<tuple<int, char>>>));
    }
    {
    ...
    // -scalar >> -scalar
    {
        ...
        using attr_t = decltype(parse(first, last, parser));
        BOOST_MPL_ASSERT(
            (is_same<attr_t, std::optional<std::vector<std::optional<char>>>>));
    }
    {
        constexpr auto parser = eps >> -char_ >> -char_;
        using attr_t = decltype(parse(first, last, parser));
    ...
    }
    {
        ...
        BOOST_MPL_ASSERT(
            (is_same<
                attr_t,
                std::optional<
                    tuple<std::optional<int>, std::optional<char>>>>));
    }
    {
        constexpr auto parser = eps >> -int_ >> -char_;
        using attr_t = decltype(parse(first, last, parser));
