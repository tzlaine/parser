...
#if defined(__cpp_explicit_this_parameter) && BOOST_PARSER_USE_CONCEPTS
...
// contents.
#if !BOOST_PARSER_USE_CONCEPTS && !BOOST_PARSER_USE_DEDUCED_THIS
...
#elif BOOST_PARSER_USE_CONCEPTS && !BOOST_PARSER_USE_DEDUCED_THIS
