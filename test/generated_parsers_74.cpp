...
TEST(parser, generated_74_000)
{
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(eps >> *char_ >> *char_);
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_001)
{
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
...
TEST(parser, generated_74_002)
{
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(*char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
...
TEST(parser, generated_74_003)
{
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_004)
{
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_005)
{
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_006)
{
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<int>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_007)
{
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<optional<int>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<std::vector<char>, std::vector<optional<int>>>>>>));
...
TEST(parser, generated_74_008)
{
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(-int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (*char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_74_009)
{
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (*char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<std::vector<char>, optional<int>>>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_74_010)
{
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (-int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_74_011)
{
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_74_012)
{
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | -(-int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_013)
{
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, optional<std::vector<char>>>>>));
...
TEST(parser, generated_74_014)
{
    {
        constexpr auto parser = -(eps >> eps >> -int_ >> eps) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (eps >> eps >> -int_ >> eps) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<int>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_74_019)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> -int_) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_029)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> -int_) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_74_044)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> -int_) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<char>>>>));
...
TEST(parser, generated_74_046)
{
    ...
    {
        constexpr auto parser = (-int_ >> *char_ >> -int_) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<optional<int>, std::vector<char>, optional<int>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_74_048)
{
    ...
    {
        constexpr auto parser = -(-int_ >> *char_ >> -int_) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<optional<int>, std::vector<char>, optional<int>>>, optional<int>>>>));
