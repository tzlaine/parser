...
def main(ctx):
  return [
    ...
    # OSX
    job(compiler='clang',     cxxstd='17,2a',    os='osx-xcode-10.1'),
    job(compiler='clang',     cxxstd='17,2a',    os='osx-xcode-10.3'),
    job(compiler='clang',     cxxstd='17,2a',    os='osx-xcode-11.1'),
    job(compiler='clang',     cxxstd='17,2a',    os='osx-xcode-11.7'),
    job(compiler='clang',     cxxstd='17,2a',    os='osx-xcode-12'),
    job(compiler='clang',     cxxstd='17,20',    os='osx-xcode-12.5.1'),
    job(compiler='clang',     cxxstd='17,20',    os='osx-xcode-13.0'),
    job(compiler='clang',     cxxstd='17,20',    os='osx-xcode-13.4.1'),
    job(compiler='clang',     cxxstd='17,20,2b', os='osx-xcode-14.0'),
    job(compiler='clang',     cxxstd='17,20,2b', os='osx-xcode-14.3.1'),
    job(compiler='clang',     cxxstd='17,20,2b', os='osx-xcode-15.0.1'),
    # ARM64
    job(compiler='clang-12',  cxxstd='17,20', os='ubuntu-20.04', arch='arm64', add_llvm=True),
