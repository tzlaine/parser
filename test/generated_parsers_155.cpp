...
TEST(parser, generated_155_016)
{
    ...
    }
    {
        ...
        EXPECT_FALSE(fail_attr);
        {
            tuple<variant<std::vector<char>, optional<int>>, std::vector<char>, std::vector<int>> attr;
            auto const copy = attr;
            EXPECT_FALSE(parse(first, last, fail_parser, attr));
            EXPECT_EQ(attr, copy);
        }
