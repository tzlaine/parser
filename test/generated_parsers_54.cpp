...
TEST(parser, generated_54_000)
{
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(eps >> eps >> *char_ >> eps);
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_001)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_002)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (*char_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> *char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, std::vector<optional<int>>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (*char_ >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_003)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_004)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (-int_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_005)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_006)
{
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (-int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(eps >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_007)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<char>>>>));
...
TEST(parser, generated_54_008)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_54_009)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> *char_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<char>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_010)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> -int_ >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<tuple<std::vector<char>, optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_011)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> *char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<char>>>>));
...
TEST(parser, generated_54_012)
{
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, std::vector<optional<int>>>>, optional<int>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> eps >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_54_013)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<int>>>>));
...
TEST(parser, generated_54_014)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<tuple<std::vector<char>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (*char_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<char>>>>));
...
TEST(parser, generated_54_015)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(eps >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<tuple<std::vector<char>, optional<int>>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, std::vector<optional<int>>>>, tuple<std::vector<char>, optional<int>>>>>));
...
TEST(parser, generated_54_016)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> eps >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<optional<int>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_017)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (-int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, tuple<optional<int>, std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<tuple<optional<int>, std::vector<char>, optional<int>>>>>>));
...
TEST(parser, generated_54_018)
{
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (-int_ >> *char_ >> *char_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> eps >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<std::vector<optional<int>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (-int_ >> *char_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, tuple<optional<int>, std::vector<char>>>>>));
...
TEST(parser, generated_54_019)
{
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<optional<tuple<std::vector<char>, std::vector<optional<int>>>>, optional<tuple<optional<int>, std::vector<char>>>>>>));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> -int_ >> -int_ >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_020)
{
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(*char_ >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, optional<std::vector<char>>>>>));
    ...
    {
        constexpr auto parser = -(*char_ >> -int_ >> -int_ >> eps) | (*char_ >> -int_ >> *char_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | -(-int_ >> *char_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_021)
{
    ...
    {
        constexpr auto parser = (*char_ >> -int_ >> -int_ >> eps) | (eps >> -int_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<tuple<std::vector<char>, std::vector<optional<int>>>, std::vector<optional<int>>>>>));
...
TEST(parser, generated_54_022)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps) | -(*char_ >> *char_ >> -int_ >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps) | (*char_ >> -int_ >> eps >> *char_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_026)
{
    {
        constexpr auto parser = (*char_ >> *char_ >> eps) | (*char_ >> eps >> eps >> eps);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_029)
{
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps) | (*char_ >> -int_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
...
TEST(parser, generated_54_036)
{
    {
        constexpr auto parser = -(*char_ >> *char_ >> eps) | -(*char_ >> -int_ >> -int_ >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
    ...
    {
        constexpr auto parser = (*char_ >> *char_ >> eps) | -(*char_ >> *char_ >> eps >> -int_);
        using attr_t = decltype(parse(g_first, g_last, parser));
        BOOST_MPL_ASSERT((is_same<attr_t, optional<variant<std::vector<char>, optional<tuple<std::vector<char>, optional<int>>>>>>));
